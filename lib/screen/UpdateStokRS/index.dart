...
class UpdateDataRS extends StatefulWidget {
  UpdateDataRS({Key key}) : super(key: key);

  @override
  _UpdateDataRSState createState() => _UpdateDataRSState();
}

class _UpdateDataRSState extends State<UpdateDataRS> {
  var isLoading = true;
  var dataView = [];
  @override
  void initState() {
